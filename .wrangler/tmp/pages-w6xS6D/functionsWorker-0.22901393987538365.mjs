...
// ../.wrangler/tmp/bundle-WK3B9c/checked-fetch.js
...
// ../.wrangler/tmp/bundle-WK3B9c/strip-cf-connecting-ip-header.js
...
// ../node_modules/.pnpm/hono@4.11.3/node_modules/hono/dist/adapter/cloudflare-pages/handler.js
...
var toBase64Url = /* @__PURE__ */ __name((buffer) => {
...
var digest = /* @__PURE__ */ __name(async (value) => {
  const buffer = await crypto.subtle.digest("SHA-256", encoder.encode(value));
  return toBase64Url(buffer);
}, "digest");
var normalizeEmail = /* @__PURE__ */ __name((value) => value.trim().toLowerCase(), "normalizeEmail");
var normalizeName = /* @__PURE__ */ __name((value) => value.trim().replace(/\s+/g, " "), "normalizeName");
var createSalt = /* @__PURE__ */ __name(() => crypto.randomUUID().replaceAll("-", ""), "createSalt");
var hashPassword = /* @__PURE__ */ __name(async (password, salt) => digest(`${salt}:${password}`), "hashPassword");
var verifyPassword = /* @__PURE__ */ __name(async (password, salt, passwordHash) => {
  const candidate = await hashPassword(password, salt);
  return candidate === passwordHash;
}, "verifyPassword");
var createSessionToken = /* @__PURE__ */ __name(() => crypto.randomUUID().replaceAll("-", "") + crypto.randomUUID().replaceAll("-", ""), "createSessionToken");
var hashSessionToken = /* @__PURE__ */ __name(async (token) => digest(token), "hashSessionToken");
var sessionExpiresAt = /* @__PURE__ */ __name((ttlSeconds = SESSION_TTL_SECONDS) => new Date(Date.now() + ttlSeconds * 1e3).toISOString(), "sessionExpiresAt");
var createTemporaryPassword = /* @__PURE__ */ __name(() => crypto.randomUUID().replaceAll("-", "").slice(0, 12), "createTemporaryPassword");
var toPublicMember = /* @__PURE__ */ __name((member) => ({
  id: member.id,
  email: member.email,
  name: member.name,
...
var RegistrationEmailError = class extends Error {
  kind;
...
__name(RegistrationEmailError, "RegistrationEmailError");
var isValidEmail = /* @__PURE__ */ __name((value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value), "isValidEmail");
var getEmailDomain = /* @__PURE__ */ __name((email) => email.split("@")[1]?.toLowerCase() || "", "getEmailDomain");
var looksLikeHtml = /* @__PURE__ */ __name((value) => /<\/?[a-z][\s\S]*>/i.test(value), "looksLikeHtml");
var escapeHtml = /* @__PURE__ */ __name((value) => value.replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll('"', "&quot;").replaceAll("'", "&#39;"), "escapeHtml");
var createEmailBody = /* @__PURE__ */ __name((input) => {
...
var resolveRegistrationEmailConfig = /* @__PURE__ */ __name((input) => {
...
var getMailChannelsErrorMessage = /* @__PURE__ */ __name(async (response) => {
...
var assertRegistrationEmailConfig = /* @__PURE__ */ __name((input) => {
  resolveRegistrationEmailConfig(input);
}, "assertRegistrationEmailConfig");
var sendRegistrationEmail = /* @__PURE__ */ __name(async (input) => {
...
var getMemberByEmail = /* @__PURE__ */ __name(async (db, email) => {
  if (!db || !email)
    return null;
...
var getMemberById = /* @__PURE__ */ __name(async (db, memberId) => {
  if (!db || !memberId)
    return null;
  const result = await db.prepare(
    `
...
var createMember = /* @__PURE__ */ __name(async (db, input) => {
  if (!db)
    return null;
  await db.prepare(
    `
...
var createMemberSession = /* @__PURE__ */ __name(async (db, input) => {
  if (!db)
    return null;
...
var getSessionMember = /* @__PURE__ */ __name(async (db, token) => {
  if (!db || !token)
    return null;
...
var updateMemberPassword = /* @__PURE__ */ __name(async (db, input) => {
  if (!db)
    return null;
  await db.prepare(
    `
...
var revokeSession = /* @__PURE__ */ __name(async (db, token) => {
  if (!db || !token)
    return;
  const tokenHash = await hashSessionToken(token);
  await db.prepare(
...
var normalizeFilterValue = /* @__PURE__ */ __name((key, value) => {
...
var filterPets = /* @__PURE__ */ __name((items, filters) => {
...
var findPetById = /* @__PURE__ */ __name((id) => pets.find((pet) => pet.id === id), "findPetById");
var createPetApiPayload = /* @__PURE__ */ __name((items, filters = {}) => {
...
// ../src/lib/favorites-db.ts
var parseTags = /* @__PURE__ */ __name((value) => {
  try {
...
var getFavoritesFromDatabase = /* @__PURE__ */ __name(async (db, ownerId) => {
  if (!db || !ownerId) {
    return [];
  }
  const result = await db.prepare(
...
var sortByOrder = /* @__PURE__ */ __name((items) => [...items], "sortByOrder");
var toStory = /* @__PURE__ */ __name((row) => ({
  id: row.id,
  title: row.title,
  quote: row.quote,
  author: row.author,
...
var toShelter = /* @__PURE__ */ __name((row) => ({
  id: row.id,
  icon: row.icon,
  name: row.name,
  description: row.description,
...
var getStoriesFromDatabase = /* @__PURE__ */ __name(async (db) => {
  if (!db) {
...
var getSheltersFromDatabase = /* @__PURE__ */ __name(async (db) => {
  if (!db) {
...
// ../src/lib/paws-db.ts
var parseTags2 = /* @__PURE__ */ __name((value) => {
  try {
    const parsed = JSON.parse(value);
    return Array.isArray(parsed) ? parsed.filter((item) => typeof item === "string") : [];
  } catch {
...
var toPet2 = /* @__PURE__ */ __name((row) => ({
  id: row.id,
  name: row.name,
  species: row.species,
  gender: row.gender,
...
var sortFallbackPets = /* @__PURE__ */ __name(() => [...pets], "sortFallbackPets");
var getPetsFromDatabase = /* @__PURE__ */ __name(async (db) => {
  if (!db) {
...
var getPetByIdFromDatabase = /* @__PURE__ */ __name(async (db, id) => {
  if (!db) {
...
// api/[[path]].ts
var parseLimit = /* @__PURE__ */ __name((value, fallback = 10, max = 20) => {
  const parsed = Number(value);
  if (!Number.isFinite(parsed))
    return fallback;
  return Math.max(1, Math.min(max, Math.floor(parsed)));
}, "parseLimit");
var parseTagsJson = /* @__PURE__ */ __name((value) => {
  if (!value)
    return [];
  try {
    const parsed = JSON.parse(value);
...
var isSecureRequest = /* @__PURE__ */ __name((url) => new URL(url).protocol === "https:", "isSecureRequest");
var isLocalOrigin = /* @__PURE__ */ __name((origin) => origin === "http://localhost:4321" || origin === "http://127.0.0.1:4321", "isLocalOrigin");
...
// ../.wrangler/tmp/pages-w6xS6D/functionsRoutes-0.4360090110978476.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../node_modules/.pnpm/wrangler@3.114.16_@cloudflare+workers-types@4.20260101.0/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-WK3B9c/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-WK3B9c/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.22901393987538365.mjs.map
